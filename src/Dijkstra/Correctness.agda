...
module UsingAdj {n} (i : Fin (suc n)) (adj : Adj (suc n)) where
  ...
  open Properties-UsingAdj i adj
...
-}
  ...
  mutual
    ...
    estimate-preserved ctd       {lt} j j∈vs′ with visited-preserved′ ctd j∈vs′
    estimate-preserved ctd       {lt} j j∈vs′ | inj₁ j≡q  = q-minimum′ ctd j≡q
    estimate-preserved zero      {lt} j j∈vs′ | inj₂ j∈vs = sym (start-minimum zero j (start-visited′ j j∈vs))
    estimate-preserved (suc ctd) {lt} j j∈vs′ | inj₂ j∈vs = sym eq
      where
        open EqR setoid
...
{-
    ...
    correct-step (suc ctd) j j∈visited′ with visited-preserved′ ctd j∈visited′
    ... | inj₁ j≡q = {!!}
